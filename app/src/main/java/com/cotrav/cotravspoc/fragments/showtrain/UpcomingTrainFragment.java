...
import com.cotrav.cotravspoc.adapter.trainadapters.UpcomingTrainBookingAdapter;
 ...
 */
public class UpcomingTrainFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup parent,
        ...
        final View view = layoutInflater.inflate(R.layout.fragment_upcoming_train, parent, false);
        ...
        trainBookingsViewModel.getUpcomingLiveData(authorization,usertype,spoc_id).observe(this, new Observer<List<TrainBooking>>() {
            @Override

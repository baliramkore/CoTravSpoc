...
public class CancelledTaxiBookingAdapter extends RecyclerView.Adapter<CancelledTaxiBookingAdapter.MyViewHolder> {
    ...
    public CancelledTaxiBookingAdapter(FragmentActivity activity, List<TaxiBooking> taxiBookingList, String bookingStatus) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder viewHolder, int position)
    {
        ...
        if (taxiBookingList.get(position).getTourType().equals("3"))
            viewHolder.bookingTourType.setText("Out Station");
                        ...
                        alertDialogBuilder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int id) {
                                ...
                                context.startActivity(new Intent(Intent.ACTION_CALL,
                                        Uri.parse("tel:" + taxiBookingList.get(position).getUserName())));
                            }
                        });

...
import com.cotrav.cotravspoc.adapter.hoteladapter.TodaysHotelBookingAdapter;
...
public class TodaysHotelFragment  extends Fragment implements SwipeRefreshLayout.OnRefreshListener{
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup parent,
        ...
        hotelBookingsViewModel.getTodaysLiveData(authorization,usertype,spoc_id).observe(this, new Observer<List<HotelBooking>>() {
            @Override
                ...
                if (s.equals("No Bookings Available")) {
                    ...
                    Snackbar.make(view, s, Snackbar.LENGTH_LONG).setAction("try again", new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            swipeRefreshLayout.setRefreshing(true);
                            hotelBookingsViewModel.refreshTodaysBooking(authorization,usertype,spoc_id);
                        }
                    }).show();
                }
            }

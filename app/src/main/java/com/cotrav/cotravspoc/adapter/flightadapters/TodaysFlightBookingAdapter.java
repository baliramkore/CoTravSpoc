...
import com.cotrav.cotravspoc.models.show_flight_model.view_flight.Flight;
...
public class TodaysFlightBookingAdapter extends RecyclerView.Adapter<TodaysFlightBookingAdapter.MyViewHolder>
{

    private FragmentActivity activity;
    private List<FlightBooking> flightBookingList;
    private List<Flight> flightDetailsBookingList;
    ...
    public TodaysFlightBookingAdapter(FragmentActivity activity, List<FlightBooking> flightBookingList, String bookingStatus) {

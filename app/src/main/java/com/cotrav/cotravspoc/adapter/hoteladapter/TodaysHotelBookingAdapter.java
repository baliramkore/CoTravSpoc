...
public class TodaysHotelBookingAdapter extends RecyclerView.Adapter<TodaysHotelBookingAdapter.MyViewHolder> {
    ...
    public TodaysHotelBookingAdapter(FragmentActivity activity, List<HotelBooking> hotelBookingList, String bookingStatus)
    {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder viewHolder, int position)
    {
       ...
       // viewHolder.bookingSpocName.setText(hotelBookingList.get(position).getUserName());
        ...
        viewHolder.bookingDate.setText(hotelBookingList.get(position).getBookingDatetime());
        ...
        try {
            Date date11 = df1.parse(bookdate);

...
import com.cotrav.cotravspoc.adapter.flightadapters.UpcomingFlightBookingAdapter;
 ...
 */
public class UpcomingFlightFragment extends Fragment  implements SwipeRefreshLayout.OnRefreshListener  {
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup parent,
        ...
        final View view = layoutInflater.inflate(R.layout.fragment_upcoming_flight, parent, false);
        ...
        flightBookingsViewModel.getUpcomingLiveData(authorization,usertype,spoc_id).observe(this, new Observer<List<FlightBooking>>() {
            @Override
                ...
                if (s.equals("No Bookings Available")) {
                    ...
                    Snackbar.make(view, s, Snackbar.LENGTH_LONG).setAction("try again", new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            swipeRefreshLayout.setRefreshing(true);
                            flightBookingsViewModel.refreshUpcomingBooking(authorization,usertype,spoc_id);
                        }
                    }).show();
                }
            }

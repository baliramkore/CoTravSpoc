...
import com.cotrav.cotravspoc.adapter.taxiadapters.CompletedTaxiBookingAdapter;
...
*/
        ...
        taxiBookingsViewModel.getPastLiveData(authorization,usertype,spoc_id).observe(this, new Observer<List<TaxiBooking>>() {
            @Override
            ...
            public void onChanged(String s) {
                ...
                if (s.equals("No Bookings Available")) {
                    ...
                    Snackbar.make(view, s, Snackbar.LENGTH_LONG).setAction("try again", new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            swipeRefreshLayout.setRefreshing(true);
                            taxiBookingsViewModel.refreshPastBooking(authorization,usertype,spoc_id);
                        }
                    }).show();
                }
            }

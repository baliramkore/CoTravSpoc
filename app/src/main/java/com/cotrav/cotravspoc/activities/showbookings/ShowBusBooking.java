...
import com.cotrav.cotravspoc.adapter.BusTabAdapter;
import com.google.android.material.floatingactionbutton.FloatingActionButton;
import com.google.android.material.tabs.TabLayout;

public class ShowBusBooking extends AppCompatActivity {
    LifecycleRegistry lifecycleRegistry;
    private BusTabAdapter busTabAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_show_bus_booking);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(ShowBusBooking.this, AddBusBookingActivity.class);
        ...
        busTabAdapter = new BusTabAdapter(getSupportFragmentManager(), tabLayout.getTabCount());
        viewPager.setAdapter(busTabAdapter);

...
public class CancelledBusBookingAdapter extends RecyclerView.Adapter<CancelledBusBookingAdapter.MyViewHolder>
{
    ...
    public CancelledBusBookingAdapter(FragmentActivity activity, List<BusBooking> busBookingList, String bookingStatus) {
